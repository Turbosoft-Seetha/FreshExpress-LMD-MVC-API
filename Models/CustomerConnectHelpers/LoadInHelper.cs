...
namespace MVC_API.Models.CustomerConnectHelpers
{
    ...
    public class LoadInDetailOut
    {
        ...
        public string LoadInUOM { get; set; }

    }
    public class PostItemLoadInCus
    {
        public string cus_HeaderID { get; set; }

    }
    public class PostItemLoadInCusOutlet
    {
        public string ID { get; set; }

    }
    public class PostItemLoadInRot
    {
        public string rot_ID { get; set; }

    }
    public class PostItemLoadInOrder
    {
        public string ordNo { get; set; }
    }
    public class PostItemLoadInProducts
    {
        public string prd_ID { get; set; }
    }
    public class PostItemLoadInStatus
    {
        public string Status { get; set; }
    }
    public class LoadInCustomersIn
    {
    ...
    public class LoadInCustomersOut
    {
        public string cus_HeaderID { get; set; }
        public string cus_HeaderCode { get; set; }
        public string cus_HeaderName { get; set; }
